...
# --- Usage ---
# sh eval_vizwiz.sh <STAGE> <MODEL_PATH> <GPU> <EXPERT_NUM>

STAGE=${1:-"hide"}
MODEL_PATH=${2:-"/home/hechen/zms/MLLM_Factory/HiDe-LLaVA/output/ucit/Task3_llava_lora_ours"}
GPU=${3:-"0"}
EXPERT_NUM=${4:-3}
...
echo "Starting evaluation: VizWiz | expert_num=$EXPERT_NUM, cur_task=$CUR_TASK, GPU=$GPU"
