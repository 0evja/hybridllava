...
# --- Usage ---
# sh eval_arxivqa.sh <STAGE> <MODEL_PATH> <GPU> <EXPERT_NUM>

STAGE=${1:-"hide"}
MODEL_PATH=${2:-"/home/hechen/zms/MLLM_Factory/HiDe-LLaVA/output/ucit/Task2_llava_lora_ours"}
GPU=${3:-"0"}
EXPERT_NUM=${4:-2}
...
QUESTION_FILE="${BASE_DIR}/instructions/ArxivQA/test_3000.json"
IMAGE_FOLDER="/data1/zms/datasets"
RESULT_DIR="${RESULT_BASE:-./results/UCIT}/each_dataset/ArxivQA"
...
echo "Starting evaluation: ArxivQA | expert_num=$EXPERT_NUM, cur_task=$CUR_TASK, GPU=$GPU"
